      ...
      <div className="flex-1 py-2 flex flex-col justify-between pr-4">
        <div className="space-y-1">
          <div className="flex justify-between items-start">
            <span className="text-[10px] font-black text-[#2d5a27] uppercase tracking-[0.2em] leading-none mb-1">
              {item.category?.name || "Featured"}
            </span>
          </div>
          <h4 className="font-serif font-semibold text-xl text-zinc-900 group-hover:text-[#2d5a27] transition-colors leading-tight tracking-tight">
            {item.name}
          </h4>
        ...
        <div className="flex items-center justify-between mt-3">
          <div className="bg-[#2d5a27]/10 text-[#2d5a27] px-4 py-1.5 rounded-2xl text-lg font-serif font-semibold tracking-tight border border-[#2d5a27]/20 shadow-sm">
            ₹{item.price}
          </div>
